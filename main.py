...
def gerar_layout_grafico_multitek_cb(elemento):
    return html.Div([
        ...
        html.Br(),
        dcc.Input(id=f'input-valor-multitek_cb-{elemento}', type='number', placeholder=f'% de {elemento}', debounce=True),
...
def gerar_layout_grafico_multitek_cm(elemento):
    return html.Div([
        ...
        html.Br(),
        dcc.Input(id=f'input-valor-multitek_cm-{elemento}', type='number', placeholder=f'% de {elemento}', debounce=True),
...
def gerar_layout_grafico_multitek_ca(elemento):
    return html.Div([
        ...
        html.Br(),
        dcc.Input(id=f'input-valor-multitek_ca-{elemento}', type='number', placeholder=f'% de {elemento}', debounce=True),
...
def gerar_layout_grafico_oxford(elemento):
    return html.Div([
        ...
        html.Br(),
        dcc.Input(id=f'input-valor-oxford-{elemento}', type='number', placeholder=f'% de {elemento}', debounce=True),
